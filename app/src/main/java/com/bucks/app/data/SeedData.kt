...
object Seed {
    ...
    val providers: List<Provider> = listOf(
        ...
        Provider("p6", ProviderType.SKILL, "Plumber", "Suresh M", listOf("plumber","leak","tap","pipe","bathroom"), 28f, 40f, 1.8, 143, 4, Scope.LOCAL, "12 yrs experience. Leaks, fittings, water heaters.", emptyList(), "₹300 visit + parts", listOf(c("Vinod","Fixed a hidden leak in 30 min",1),c("Rekha","Came on time, fair price",1,"u-rekha-s"))),
        ...
        Provider("p8", ProviderType.SKILL, "Doctor", "Dr. Kavya Rao", listOf("doctor","fever","clinic","physician","general"), 58f, 26f, 1.0, 410, 7, Scope.LOCAL, "MBBS, MD General Medicine. Clinic 9–1, 5–8.", emptyList(), "₹400 consult", listOf(c("Hari","Listens patiently, explains clearly",1),c("Divya","Wait time 45 min",-1),c("Mohan","Great with kids",1,"u-mohan-das"))),
